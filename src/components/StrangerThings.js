...
const strangerThingsConfig = {
  // url: 'http://localhost:3002',  // Substituido pela variável de ambiente
  // timeout: 30000,                // Substituido pela variável de ambiente
  url: process.env.REACT_APP_HAWKINS_URL,
  timeout: process.env.REACT_APP_HAWKINS_TIMEOUT,
};

const upsideDownConfig = {
  // url: 'http://localhost:3003',  // Substituido pela variável de ambiente
  // timeout: 30000,                // Substituido pela variável de ambiente
